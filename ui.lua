...
function Flux:Window(text, bottom,mainclr,toclose)
	...
	function Flux:Notification(desc,buttontitle)
		...
		CloseBtn.BackgroundColor3 = Color3.fromRGB(70, 80, 180)
	...
	function Tabs:Tab(text,ico)
		...
		TabTitle.Position = UDim2.new(0.4, 0, 0.28, 0)
		...
		Tab.MouseEnter:Connect(function()
			TweenService:Create(
				...
				{BackgroundColor3 = Color3.fromRGB(70,80,180)}
			):Play()
		end)
		...
		function ContainerContent:Button(text, desc, callback)
			...
			Button.BackgroundColor3 = Color3.fromRGB(70, 80, 180)
			...
			CircleSmall.BackgroundColor3 = Color3.fromRGB(70, 80, 180)
		...
		function ContainerContent:Toggle(text, desc,default, callback)
			...
			Toggle.BackgroundColor3 = Color3.fromRGB(70, 80, 180)
		...
		function ContainerContent:Slider(text,desc,min,max,start,callback)
			...
			Slider.BackgroundColor3 = Color3.fromRGB(70, 80, 180)
		...
		function ContainerContent:Dropdown(text,list,callback)
			...
			Dropdown.BackgroundColor3 = Color3.fromRGB(70, 80, 180)
		...
		function ContainerContent:Colorpicker(text,preset,callback)
			...
			Colorpicker.BackgroundColor3 = Color3.fromRGB(70, 80, 180)
			...
			Confirm.BackgroundColor3 = Color3.fromRGB(0, 0, 135)
		...
		function ContainerContent:Label(text)
			...
			Label.BackgroundColor3 = Color3.fromRGB(70, 80, 180)
		...
		function ContainerContent:Textbox(text,desc,disapper,callback)
			...
			Textbox.BackgroundColor3 = Color3.fromRGB(70, 80, 180)
		...
		function ContainerContent:Bind(text,presetbind,callback)
			...
			Bind.BackgroundColor3 = Color3.fromRGB(70, 80, 180)
